DIRS := button Edit component composite LinearContainer Text window design tasks/task_1 tasks/task_2 tasks/task_3 tasks/task_8 tasks/task_9 tasks/task_12 terms tasks/task_4
